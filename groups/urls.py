...
urlpatterns = [
    ...
    path(
        "<int:group_id>/", views.GroupMembersView.as_view(), name="list_group_members"
    ),
    ...
    path(
        "<uuid:uuid>/add-user/",
        views.AddUserToGroupView.as_view(),
        name="add-user-to-group",
    ),
    path(
        "<int:group_id>/activities/",
        views.GroupActivityView.as_view(),
        name="group_activities",
    ),
    path(
        "<int:group_id>/overview/", views.GroupOverview.as_view(), name="group_overview"
    ),
]
